...
#include "demo/demo_shell/common/demo_shell_origin_trial_policy.h"
...
DemoShellOriginTrialPolicy::DemoShellOriginTrialPolicy()
...
bool DemoShellOriginTrialPolicy::IsOriginTrialsSupported() const {
  return base::FeatureList::IsEnabled(features::kOriginTrials);
}

base::StringPiece DemoShellOriginTrialPolicy::GetPublicKey() const {
  return public_key_;
}

bool DemoShellOriginTrialPolicy::IsOriginSecure(const GURL& url) const {
